...
namespace VRising.GameData.Models.Internals
{
    public class BaseEntityModel
    {
        ...
        public PostLoadCommandBuffer PostLoadCommandBuffer => _world.EntityManager.TryGetComponentDataInternal<PostLoadCommandBuffer>(_entity, out var value) ? value : null;
        ...
        public RetainBlobAssets RetainBlobAssets => _world.EntityManager.TryGetComponentDataInternal<RetainBlobAssets>(_entity, out var value) ? value : null;
        public RetainBlobAssetBatchPtr? RetainBlobAssetBatchPtr => _world.EntityManager.TryGetComponentDataInternal<RetainBlobAssetBatchPtr>(_entity, out var value) ? value : null;
        ...
        public bool SceneTag => _world.EntityManager.HasComponentInternal<SceneTag>(_entity);
        public List<Unity.Transforms.Child> Children => _world.EntityManager.GetBufferInternal<Unity.Transforms.Child>(_entity);
        public bool SceneSection => _world.EntityManager.HasComponentInternal<SceneSection>(_entity);
