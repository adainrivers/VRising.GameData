...
namespace VRising.GameData.Models.Internals
{
    public class BaseManagedDataModel
    {
        ...
        public ProjectM.VoiceData VoiceData => _world.GetManagedComponentDataInternal<ProjectM.VoiceData>(_entityModel);
        public ProjectM.ManagedRepairStationData ManagedRepairStationData => _world.GetManagedComponentDataInternal<ProjectM.ManagedRepairStationData>(_entityModel);
        ...
        public ProjectM.ManagedItemSet ManagedItemSet => _world.GetManagedComponentDataInternal<ProjectM.ManagedItemSet>(_entityModel);
